  ...
  return (
    <LandingMotion>
      <main className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 space-main-y">
        {/* Logo — inline SVG with fill="currentColor" for clean color control */}
        <div data-motion="logo" className="text-bs-cream">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1389.1 879.04"
            fill="currentColor"
            style={{ width: "clamp(80px, 12dvh, 120px)" }}
        ...
        {/* Title block */}
        <div className="space-logo-gap text-center">
          <p
            data-motion="every-monday"
            className="shimmer-text font-[family-name:var(--font-brand)] text-[10px] tracking-[0.45em] text-bs-cream/30 uppercase"
          >
            Every Monday
          </p>
          <h1
          ...
          <p
            ...
            className="font-body text-[10px] text-bs-cream mt-5 tracking-[0.15em] uppercase"
          >
        ...
        <div className="space-divider flex items-center justify-center w-full max-w-[320px]">
          <div
            data-motion="divider"
            className="h-px w-full bg-gradient-to-r from-transparent via-bs-gold/20 to-transparent"
          />
        </div>
        ...
        <p
          ...
          className="font-body text-[10px] text-bs-cream space-microcopy text-center tracking-wide"
        >
          Iscriviti. Lineup e date prima di tutti.
        </p>

        {/* Footer */}
        <div data-motion="footer" className="mt-auto space-footer text-center">
          <a
            href="https://instagram.com/blacksheep.community_"
            target="_blank"
            rel="noopener noreferrer"
            className="font-body text-[10px] text-bs-cream hover:text-bs-cream transition-colors duration-300 tracking-[0.1em] uppercase py-2 inline-block"
          >
